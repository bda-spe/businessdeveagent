  ...
  const [{ agentResponse, estimate }, requestSummary] = await Promise.all([
    generateAgentResponse({
      ...
      services: services.map((s) => ({
        ...
        billableLaborRate: s.billableLaborRate,
        unitType: s.unitType,
        unitPrice: s.unitPrice,
        avgCrewSize: s.avgCrewSize,
        minCrewSize: s.minCrewSize,
        maxCrewSize: s.maxCrewSize,
        estimatedLaborHours: s.estimatedLaborHours,
        requiresMeasurements: s.requiresMeasurements,
        requiresMaterialSelection: s.requiresMaterialSelection,
        lowJobCost: s.lowJobCost,
        avgJobCost: s.avgJobCost,
        highJobCost: s.highJobCost,
        lowCostJobs: s.lowCostJobs,
        highCostJobs: s.highCostJobs,
        priceIncreaseFactors: s.priceIncreaseFactors,
        priceDecreaseFactors: s.priceDecreaseFactors,
