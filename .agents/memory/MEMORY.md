...
- [Object storage router split](object-storage-router-split.md) — mount object-serving GETs public but keep upload-URL minting behind requireAuth; never expose the whole storage router publicly.
